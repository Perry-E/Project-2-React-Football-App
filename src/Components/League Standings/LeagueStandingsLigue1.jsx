...
export default function LeagueStandingsLaLiga(props) {
  ...
  const leagueName = props.leagueTable?.[4].response[0]?.league?.name;
  const leagueLogo = props.leagueTable?.[4].response[0]?.league.logo;
  const leagueFlag = props.leagueTable?.[4].response[0]?.league?.flag;
  const leagueTable = props.leagueTable?.[4].response[0]?.league?.standings[0];
