...
export default function LeagueStandingsLaLiga(props) {
  console.log("League Standings La Liga", props.leagueTable?.[1].response[0]?.league?.standings[0]);
  const leagueName = props.leagueTable?.[1].response[0]?.league?.name;
  const leagueLogo = props.leagueTable?.[1].response[0]?.league.logo;
  const leagueFlag = props.leagueTable?.[1].response[0]?.league?.flag;
  const leagueTable = props.leagueTable?.[1].response[0]?.league?.standings[0];
