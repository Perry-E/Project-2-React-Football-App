...
useEffect(() => {
    ...
    //     )    
    // })
  const upcomingGames = props.upcoming?.[2]?.response;
  ...
  return (
    <>
      <div>
        <div>
          <SideBar />
          <h1 style={{ textAlign: "center" }}>All Matches (Bundesliga)</h1>
...
export default UpcomingMatchesBundesliga;
