...
useEffect(() => {
    ...
    //     )    
    // })
  const upcomingGames = props.upcoming?.[4]?.response;
  ...
  return (
    <>
      <div>
        <div>
          <SideBar />
          <h1 style={{ textAlign: "center" }}>All Matches (Ligue 1)</h1>
...
export default UpcomingMatchesLigue1;
